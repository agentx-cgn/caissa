...
const CompPages    = [Error, Menu, Sources, Games, Game, Plays, Preferences, System, Openings, Volumes, Groups, Chapters, Variations ];
...
const ConfigPages  = H.create({
    ...
    '/preferences/':      [ Layout, Preferences,  Board, { title: 'Preferences'} ],
